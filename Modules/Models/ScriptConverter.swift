...
public enum ScriptConverter {
  public static func encode(script: Script) -> Data {
    var scriptData = Data()
  ...
  public static func decode(data: Data) throws -> Script {
    ...
    while it < data.count {
      ...
      case 0x01 ... 0x4E:
        ...
        chunks.append(ScriptChunk(scriptData: data, index: it, payloadRange: range))
        it = range.upperBound
      default:
        chunks.append(ScriptChunk(scriptData: data, index: it, payloadRange: nil))
        it += 1
      }
    }
