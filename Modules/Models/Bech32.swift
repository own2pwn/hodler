...
public enum Bech32 {
  ...
  private static let checksumMarker = "1"
  ...
  private static func extractChecksumWithEncoding(hrp: String, checksum: Data) -> (check: UInt32, encoding: Encoding)? {
  ...
  /// Create checksum
  private static func createChecksum(hrp: String, values: Data, encoding: Encoding) -> Data {
  ...
  public static func encode(_ hrp: String, values: Data, encoding: Encoding) -> String {
  ...
  public static func decode(_ str: String) throws -> (hrp: String, checksum: Data, encoding: Encoding) {
...
public extension Bech32 {
  ...
  enum Encoding {
    ...
    public var checksumXorConstant: UInt32 {
      switch self {
    ...
    public static func fromCheck(_ check: UInt32) -> Encoding? {
      switch check {
